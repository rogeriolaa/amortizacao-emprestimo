...
class Amortizacao {
     ...
     * ```
     */
    static sac(principal, taxaAnual, n) {
        if (principal <= 0)
            throw new Error("Principal deve ser maior que zero");
        if (taxaAnual < 0)
            throw new Error("Taxa anual não pode ser negativa");
        if (n <= 0)
     ...
     * ```
     */
    static price(principal, taxaAnual, n) {
        if (principal <= 0)
            throw new Error("Principal deve ser maior que zero");
        if (taxaAnual < 0)
            throw new Error("Taxa anual não pode ser negativa");
     ...
     * ```
     */
    static sam(principal, taxaAnual, n) {
        if (principal <= 0)
            throw new Error("Principal deve ser maior que zero");
        if (taxaAnual < 0)
            throw new Error("Taxa anual não pode ser negativa");
